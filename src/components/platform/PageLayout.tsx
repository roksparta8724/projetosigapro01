      ...
      <div className="relative flex flex-col gap-3 xl:flex-row xl:items-start xl:justify-between">
        <div className="min-w-0 flex-1">
          ...
          <div className="flex items-start gap-3">
            {Icon ? (
              <div className="sig-header-icon flex h-10 w-10 shrink-0 items-center justify-center rounded-[14px] border border-slate-300/90 bg-[linear-gradient(180deg,#ffffff_0%,#f4f8fc_100%)] text-[#2563eb] shadow-[0_8px_18px_rgba(15,23,42,0.06)] backdrop-blur-sm">
    ...
    >
      <div className={cn("flex flex-col gap-3 border-b border-slate-200/90 pb-4 lg:flex-row lg:items-start lg:justify-between", headerClassName)}>
        <div className="min-w-0 flex-1">
          <div className="flex items-start gap-3">
            {Icon ? (
              <div className="sig-section-icon mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-[12px] border border-slate-300/90 bg-[linear-gradient(180deg,#ffffff_0%,#f4f8fc_100%)] text-[#2563eb] shadow-[0_8px_18px_rgba(15,23,42,0.055)]">
