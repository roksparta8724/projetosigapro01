...
export function LandingFooter({ navItems, onOpenDemo }: LandingFooterProps) {
  return (
    <footer className="border-t border-slate-200 bg-[linear-gradient(180deg,#ffffff_0%,#f6f8fc_100%)]">
      <div className="mx-auto grid w-full max-w-[1660px] gap-10 px-4 py-14 sm:px-6 lg:grid-cols-[1.24fr_0.74fr_0.82fr] lg:px-7 xl:px-8 2xl:px-10">
        <div>
      ...
      <div className="border-t border-slate-200">
        <div className="mx-auto flex w-full max-w-[1660px] flex-col gap-2 px-4 py-5 text-sm text-slate-500 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-7 xl:px-8 2xl:px-10">
